...
const teamMembers = [
  { img: "20.webp", name: "Manish Pandey", role: "Performance Marketing", delay: ".2s" },
  { img: "28.webp", name: "Geet Kaur", role: "Social Media Executive", delay: ".8s" },
  ...
  { img: "23.webp", name: "Akansha Verma", role: "Web Developer (Intern)", delay: ".8s" },
